(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_c88699._.js", {
...
const LOCATION_CONFIGS = {
    'cafe-amazon-st': {
        ...
        pieraPath: '',
        rawDataPath: 'Testing/Cafe/' // สำหรับอุณหภูมิ/ความชื้น
    }
};
...
const TESTING_PATH = 'Testing/'; // เพิ่ม path สำหรับ Testing
...
const useMonitoringData = ()=>{
    ...
    return useLocationMonitoringData({
        ...
        pieraPath: '',
        rawDataPath: 'Cafe',
        testingPath: 'Cafe' // เพิ่ม testing path
    });
};
...
const useLocationMonitoringData = (locationData)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useLocationMonitoringData.useEffect": ()=>{
            ...
            console.log('Testing Path:', locationData.testingPath);
            if (dataSource === 'testing') {
                // ===== CAFE AMAZON: ใช้ Testing/Cafe สำหรับ PC0.1 + RAWdata สำหรับอุณหภูมิ/ความชื้น =====
                const testingFirebasePath = `/${TESTING_PATH}${locationData.testingPath}/${datePath}`;
                const rawFirebasePath = `/${RAW_PATH}${locationData.rawDataPath}/${datePath}`;
                console.log('Cafe - Testing path for PC0.1:', testingFirebasePath);
                console.log('Cafe - RAW path for temp/humidity:', rawFirebasePath);
                // Query สำหรับ Testing data (PC0.1 values)
                ...
                const testingUnsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onValue"])(testingQuery, {
                    "useLocationMonitoringData.useEffect.testingUnsubscribe": (snapshot)=>{
                        ...
                        console.log('Cafe - Testing data received:', timeData);
                        if (timeData) {
                            const latestTime = Object.keys(timeData)[0];
                            const data = timeData[latestTime];
                            if (data) {
                                // ดึงค่า PC01 จาก Testing/Cafe
                                const pc01 = parseFloat(data.PC01 || 0);
                                const pm25 = parseFloat(data.PM25 || 0);
                                const pm10 = parseFloat(data.PM10 || data.PM100 || 0);
                                const airQualityStatus = determineAirQuality(pc01, 0, pm25, pm10); // ใช้ pc01 เป็นหลัก
                                const recommendations = getRecommendations(airQualityStatus);
                                console.log('Cafe - PC/PM values:', {
                                    PC01: pc01,
                                    PM25: pm25,
                                    PM10: pm10
                                });
                                setMonitoringData({
                                    "useLocationMonitoringData.useEffect.testingUnsubscribe": (prev)=>({
                                            ...prev,
                                            date: formatDisplayDate(new Date()),
                                            time: latestTime,
                            ...
                            console.log('No Testing data found for Cafe');
                        }
                    }
                }["useLocationMonitoringData.useEffect.testingUnsubscribe"]);
                    ...
                    "useLocationMonitoringData.useEffect.pieraUnsubscribe": (snapshot)=>{
                        ...
                        if (timeData) {
                            ...
                            if (data) {
                                ...
                                const airQualityStatus = determineAirQuality(0, pm01, pm25, pm10);
                                const recommendations = getRecommendations(airQualityStatus);
...
_s2(useLocationMonitoringData, "sahG/seFN03Xs9+Zi8gVcONQt6o=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2d$x$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UserX$3e$__ = __turbopack_import__("[project]/node_modules/lucide-react/dist/esm/icons/user-x.js [app-client] (ecmascript) <export default as UserX>");
...
const MonitoringPanel = ({ selectedLocation, onLocationClear })=>{
    ...
    const sensitiveStatus = data.pmReadings ? getAirQualityForGroup(parseFloat(data.pmReadings.find((r)=>r.type === 'PC01')?.value || 0), parseFloat(data.pmReadings.find((r)=>r.type === 'PM0.1')?.value || 0), parseFloat(data.pmReadings.find((r)=>r.type === 'PM2.5')?.value || 0), parseFloat(data.pmReadings.find((r)=>r.type === 'PM10')?.value || 0), 'sensitive') : 'Good';
    const generalStatus = data.pmReadings ? getAirQualityForGroup(parseFloat(data.pmReadings.find((r)=>r.type === 'PC01')?.value || 0), parseFloat(data.pmReadings.find((r)=>r.type === 'PM0.1')?.value || 0), parseFloat(data.pmReadings.find((r)=>r.type === 'PM2.5')?.value || 0), parseFloat(data.pmReadings.find((r)=>r.type === 'PM10')?.value || 0), 'general') : 'Good';
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "p-3 sm:p-4 h-full overflow-y-auto",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Animation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LiveActivityNumber"], {
                                                            value: parseFloat(data.pmReadings.find((r)=>r.type === 'PC01')?.value) || 0,
                                                            type: "cascade-slide",
                                                            decimals: 3,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: data.pmReadings.find((r)=>r.type === 'PC01')?.unit || 'PNC'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/MonitoringInterface.js",
                                                        lineNumber: 186,
                                                        columnNumber: 17
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2d$x$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UserX$3e$__["UserX"], {
                                                            className: "text-white w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 drop-shadow-lg"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/MonitoringInterface.js",
                                                            lineNumber: 203,
                                                            columnNumber: 19
...
// ส่วนแสดงข้อมูล History (ด้านขวาล่าง) - แบบแถบเลื่อนปกติ และแก้ไขการทับกับ footer
const HistorySection = ({ selectedLocation })=>{
    ...
    // Mock data สำหรับ History - เพิ่มข้อมูลมากขึ้นเพื่อทดสอบการเลื่อน
    const historyData = [
        {
            time: '15:00',
            pm01: 19.8,
    ...
    // เตรียมข้อมูลสำหรับกราฟ - แสดงทั้งหมด
...
//# sourceMappingURL=src_c88699._.js.map