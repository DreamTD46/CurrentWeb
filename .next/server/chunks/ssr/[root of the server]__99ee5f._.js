...
const mod = await __turbopack_external_import__("postcss");
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$postcss__$5b$external$5d$__$28$postcss$2c$__esm_import$29$__ = __turbopack_import__("[externals]/postcss [external] (postcss, esm_import)");
...
const getAirQualityColor = (status)=>{
    const colors = {
        Good: '#1E88E5',
        Warningforsensitivegroups: '#2DC653',
        Warning: '#FECF3E',
        Effecthealth: '#FF9500',
        Hazardous: '#D02224'
    };
...
const PM_THRESHOLDS = {
    PM01: {
        Good: 0.0,
        'Warning for sensitive groups': 0.5,
        Warning: 1.0,
        'Effect on health': 2.0,
        Hazardous: Number.MAX_VALUE
    },
    PM25: {
        Good: 15.0,
        'Warning for sensitive groups': 25.0,
        Warning: 37.5,
        'Effect on health': 75.0,
        Hazardous: Number.MAX_VALUE
    },
    PM100: {
        Good: 50.0,
        'Warning for sensitive groups': 80.0,
        moderate: 120.0,
        'Effect on health': 180.0,
        Hazardous: Number.MAX_VALUE
    }
};
const determineAirQuality = (pm01, pm25, pm100)=>{
    // Check Excellent
    if (pm01 <= PM_THRESHOLDS.PM01.Good && pm25 <= PM_THRESHOLDS.PM25.Good && pm100 <= PM_THRESHOLDS.PM100.Good) {
        return "Good";
    } else if (pm01 <= PM_THRESHOLDS.PM01.Warningforsensitive && pm25 <= PM_THRESHOLDS.PM25.Warningforsensitive && pm100 <= PM_THRESHOLDS.PM100.Warningforsensitive) {
        return "Warning for sensitive";
    } else if (pm01 <= PM_THRESHOLDS.PM01.Warning && pm25 <= PM_THRESHOLDS.PM25.Warning && pm100 <= PM_THRESHOLDS.PM100.Warning) {
        return "Warning";
    } else if (pm01 <= PM_THRESHOLDS.PM01.Effecthealth && pm25 <= PM_THRESHOLDS.PM25.Effecthealth && pm100 <= PM_THRESHOLDS.PM100.Effecthealth) {
        return "Effect on health";
    } else {
        return "Hazardous";
    }
};
...
const useLocationMonitoringData = (locationData)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (dataSource === 'piera') {
            ...
            const rawFirebasePath = `/${RAW_PATH}${locationData.rawDataPath}`;
            console.log('C4 - RAW path for all data:', rawFirebasePath);
            // ลองดึงจาก Firebase ด้วย (แต่ไม่บล็อคการทำงาน)
            const rawQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ref"])(database, rawFirebasePath), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["orderByKey"])(), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["limitToLast"])(1));
            const rawUnsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onValue"])(rawQuery, (snapshot)=>{
                const timeData = snapshot.val();
                console.log('C4 - RAW data from Firebase (อาจไม่มี):', timeData);
                if (timeData) {
                    const latestTime = Object.keys(timeData)[0];
                    const data = timeData[latestTime];
                    if (data) {
                        console.log('C4 - พบข้อมูลจริงใน Firebase! ใช้ข้อมูลจริงแทน');
                        const pm01 = parseFloat(data.PM01 || 0);
                        const pm25 = parseFloat(data.PM25 || 0);
                    ...
                    console.log('C4 - ไม่พบข้อมูลใน Firebase - ใช้ข้อมูลทดสอบต่อไป');
                }
            });
            return ()=>{
                rawUnsubscribe();
...
const getRecommendations = (airQualityStatus)=>{
    ...
    switch(airQualityStatus){
        ...
        case 'Warning for sensitive groups':
            return [
                "ไม่มีผลต่อสุขภาพสามารถใช้ชีวิตได้ตามปกติ",
                "กลุ่มเปราะบางอาจจะมีความเสี่ยงและสังเกตอาการของตนเอง",
                "สามารถเปิดหน้าต่างระบายอากาศได้"
            ];
        case 'Warning':
            return [
                "มีความเสี่ยงต่อร่างกายทั้งกลุ่มคนทั่วไปและกลุ่มเปราะบาง",
                "หลีกเลี่ยงการทำกิจกรรมที่ก่อให้เกิดฝุ่น",
                "สังเกตอาการของตนเองหากมีอาการให้ไปพบแพทย์"
            ];
        case 'Effect on health':
            return [
                "มีความเสี่ยงต่อร่างกายทั้งกลุ่มคนทั่วไปและกลุ่มเปราะบาง",
                "หลีกเลี่ยงการทำกิจกรรมที่ก่อให้เกิดฝุ่น",
                "หากมีอาการควรเตรียมยาหรืออุปกรณ์ตามคำสั่งแพทย์",
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$monitoring$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$monitoring$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
'use client';
;
;
;
...
const MonitoringPanel = ({ selectedLocation, onLocationClear })=>{
    ...
    // Debug การรับข้อมูล
    console.log('MonitoringPanel received selectedLocation:', selectedLocation);
    ...
    console.log('Default data status:', !!defaultData);
    console.log('Location data status:', !!locationData);
    console.log('Selected location for monitoring:', selectedLocation);
    // เลือกข้อมูลที่จะแสดง
    const data = selectedLocation ? locationData : defaultData;
    console.log('Final data being used:', !!data, 'from', selectedLocation ? 'location' : 'default');
    ...
    const handleRecommendationClick = ()=>{
        setSelectedRecommendations(data.recommendations);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full lg:w-1/3 bg-gray-50/50 border-r border-gray-100 overflow-auto relative",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                className: "text-lg sm:text-xl font-light text-black-800",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-xs text-gray-600 mb-2 sm:mb-3",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex rounded-lg mb-2 sm:mb-3 shadow-sm overflow-hidden",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "w-2/5 sm:w-2/5 p-2 sm:p-4 flex flex-col justify-center relative",
                                        style: {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "text-xs font-bold mb-1 text-white text-shadow-lg",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "w-3/5 sm:w-3/5 p-2 sm:p-4 text-white flex flex-col justify-center text-center",
                                        style: {
                                            backgroundColor: statusColor
                                        },
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex justify-center gap-6 sm:gap-12 text-xs mb-2 sm:mb-3 py-2 sm:py-3 bg-gray-50 rounded-lg",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            className: "flex justify-center items-center gap-6 sm:gap-10 hover:bg-gray-50 p-2 rounded-lg transition-colors w-full flex-wrap",
                                            title: "คลิกเพื่อดูคำแนะนำทั้งหมด",
                                        ...
                                        data.recommendations.length > 5 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "text-xs text-gray-500 mt-1",
                                            children: [
                                                "และอีก ",
                                                data.recommendations.length - 5,
                                                " ข้อ - คลิกเพื่อดูทั้งหมด"
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/components/MonitoringInterface.js",
                                            lineNumber: 243,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                className: "text-sm font-medium text-gray-800 mb-2 sm:mb-3",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: data.pmReadings && data.pmReadings.length > 0 ? data.pmReadings.map((reading, index)=>{
                                    // ตรวจสอบว่า reading มีข้อมูลครบ
                                    if (!reading || !reading.type || reading.value === undefined) {
                                        return null;
                                    }
                                    // แยกค่าตัวเลขจาก string หรือรับตัวเลขตรง ๆ
                                    let numericValue;
                                    ...
                                    // ตรวจสอบว่าค่าที่ได้เป็น number ที่ถูกต้อง
                                    if (isNaN(numericValue)) {
                                        return null;
                                    }
                                    // กำหนดสถานะตาม PM type และค่า
                                    let status = 'Good';
                                    if (reading.type === 'PM0.1') {
                                        if (numericValue <= 0.0) status = 'Good';
                                        else if (numericValue <= 0.5) status = 'Warning for sensitive groups';
                                        else if (numericValue <= 1.0) status = 'Warning';
                                        else if (numericValue <= 2.0) status = 'Effects on health';
                                        else status = 'Hazardous';
                                    } else if (reading.type === 'PM2.5') {
                                        if (numericValue <= 15.0) status = 'Good';
                                        else if (numericValue <= 25.0) status = 'Warning for sensitive groups';
                                        else if (numericValue <= 37.5) status = 'Warning';
                                        else if (numericValue <= 75.0) status = 'Effects on health';
                                        else status = 'Hazardous';
                                    } else if (reading.type === 'PM10') {
                                        if (numericValue <= 50.0) status = 'Good';
                                        else if (numericValue <= 80.0) status = 'Warning for sensitive groups';
                                        else if (numericValue <= 120.0) status = 'Warning';
                                        else if (numericValue <= 180.0) status = 'Effects on health';
                                        else status = 'Hazardous';
                                    }
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "rounded-lg p-1.5 sm:p-2 text-white text-center",
                                        style: {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: numericValue.toFixed(2)
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/MonitoringInterface.js",
                                                lineNumber: 306,
                                                columnNumber: 21
                                ...
                                }) : // Fallback ถ้าไม่มีข้อมูล PM readings
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "col-span-3 text-center text-xs text-gray-500 py-4",
                                    children: "ไม่มีข้อมouลมลพิษในขณะนี้"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/MonitoringInterface.js",
                                    lineNumber: 313,
                                    columnNumber: 15
            ...
            showRecommendationPopup && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                onClick: closePopup,
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-white rounded-lg max-w-md w-full mx-4 max-h-96 overflow-y-auto",
...
const Footer = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("footer", {
        className: "h-16 flex items-center justify-between p-4 bg-green-100 border-t border-green-100 flex-shrink-0",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
const MapComponent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(async ()=>{
    ...
    loading: ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "animate-spin rounded-full h-8 w-8 border-b-2 border-gray-800 mb-2 mx-auto"
                    }, void 0, false, {
...
function ClientWrapper({ onLocationSelect }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(MapComponent, {
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MonitoringInterface$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MonitoringInterface$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
'use client';
;
;
;
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ClientWrapper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ClientWrapper"], {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__99ee5f._.js.map